...
class Business(models.Model):
    ...
    google_rating = models.CharField(max_length=255, default=0, null=True)
    facebook_rating = models.CharField(max_length=255, default=0, null=True)
    yelp_rating = models.CharField(max_length=255, default=0, null=True)
